...
為了降低女生主動邀約男生的心理壓力，MVP 可提供一個比邀約更輕的訊號：「讓他注意我」。

- 女生每天最多使用 1 次「讓他注意我」。
- 這不是正式邀約，不會鎖定男生。
- 這不消耗男生的每日邀約額度。
- 男生收到後可查看女生資料；若有興趣，再由男生按「請她喝杯咖啡」進入正式邀約流程。
- 男生可以略過，不需要回覆或拒絕。
- 女生不顯示已讀、被略過或被拒絕狀態，避免造成傷害感。
- Email 與頁面文案建議：「有人想讓你注意她。她沒有直接發出邀約，只是希望你先看看她的資料。如果你也有興趣，可以請她喝杯咖啡。」
...
MVP 的 Email 不需要拆成太多節點，先以男女共用為主，避免文案與流程過度複雜。唯一例外是「注意提示」，只在女生使用「讓他注意我」後寄給男生。

| 功能 | 目的 | 主要行動 |
| --- | --- | --- |
| 新的清單 | 每天寄出當天所有新增且符合條件的對象 | 查看今日新增對象 |
| 注意提示 | 女生使用「讓他注意我」後，提醒男生查看她的資料 | 查看她的資料 |
...
- 內容是今天所有新增且符合雙方條件的對象。
- 男女共用同一封，不拆男版 / 女版。
- Email 可提示：進入交友清單後，可選擇請對方喝杯咖啡；女性也可以先使用「讓他注意我」。
...
- 只寄給男生。
- 當女生使用「讓他注意我」時寄出。
- 這不是正式邀約，不會鎖定男生，也不消耗男生的每日邀約額度。
- 男生可以查看女生資料，若有興趣再按「請她喝杯咖啡」進入正式邀約流程。
- 男生可以略過，不需要回覆；女生不看到已讀、略過或拒絕狀態。
...
- Email 可帶出發起方附上的一句話：「喝咖啡時，我最想了解你的是……」，作為第一次見面的自然開場。
- Email 需明確告知：收到邀約後，其他人 24 小時內無法再邀約自己；但自己仍然可以主動邀約其他人。
- Email 需包含安全提醒：第一次見面請選公開場所，不要透露住家或公司地址。
...
- Email 可保留發起方附上的咖啡開場問題，提醒雙方第一次見面可以從這個話題開始。
